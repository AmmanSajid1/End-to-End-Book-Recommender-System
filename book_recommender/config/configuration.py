...
from book_recommender.entity.config_entity import DataIngestionConfig, DataValidationConfig, DataTransformationConfig, ModelTrainerConfig, ModelRecommendationConfig
...
class AppConfiguration:
    ...
    def get_recommendation_config(self) -> ModelRecommendationConfig:
        try:
            ...
            book_name_serialized_objects = os.path.join(artifacts_dir, data_validation_config['serialized_object_dir'], 'book_names.pkl')
            book_pivot_serialized_objects = os.path.join(artifacts_dir, data_validation_config['serialized_object_dir'], 'book_pivot.pkl')
            ratings_and_books_serialized_objects = os.path.join(artifacts_dir, data_validation_config['serialized_object_dir'], 'clean_data.pkl')
            ...
            response = ModelRecommendationConfig(
                ...
                ratings_and_books_serialized_objects= ratings_and_books_serialized_objects,
